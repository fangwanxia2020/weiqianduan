<template>
    <div class="content">
            ...
            <el-row class="content_box_row" :gutter="10">
                <el-col :span='$colSpan + $colSpan' class="content_box_row_col">
                    <div class="content_box_row_col_details">
                        ...
                        <div class="hasReviewed-outside">
                            <img v-if="this.$route.query.commit==6" src="../../../assets/images/taskcycle/reject.png" class="img-sty"/>
                            <img v-if="this.$route.query.commit==7" src="../../../assets/images/taskcycle/hasReviewed.png" class="img-sty"/>
                        </div>
                    </div>
                </el-col>
                    ...
                    <div class="content_box_row_col_history">
                        ...
                        <div style="overflow: auto;height:200px ">
                            <div class="content_box_row_col_history_tab" v-for="(item, index) in historyList"
                                 :key="index">
                                <div class="content_box_row_col_history_tab_list"
                                     v-if="item.commit!=9&&item.commit!=10">{{item.context}}
                                </div>
                                ...
                                <div class="history-content" v-if="item.commit==9">
                                    ...
                                    <div class="flex">
                                        ...
                                        <el-rate v-model="item.score/2" disabled text-color="#ff9900"
                                                 score-template="{value}" :max="5" :allow-half="true"></el-rate>
                                    </div>
                                </div>
        ...
        <button-footer
                ...
                :showCancel="isCheck"
                :confirmText="'返回'"
                @confirm="navigater('/leadertask/auditCenter/reviewed')"
        ></button-footer>
    </div>
</template>
<script>
